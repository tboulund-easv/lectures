...
:: content ::
<div style="display: flex; gap: 30px; justify-content: center; align-items: center; margin-top: 150px;">
...
<div style="display: flex; gap: 30px; justify-content: center; margin-top: 100px;">
	<BackPack :size="140" mood="blissful" color="#EA5347" />
...
<div style="display: flex; gap: 30px; justify-content: center; align-items: center; margin-top: 50px;">
